    ...
    public void DoDecryption() {
      //  System.out.println("************************DECIPHER***********************************"+'\n');
        ...
        for(int f=0; f<PlainText.length()/8; f++){
          ...
          //  System.out.println("*********Block Number *********"+(f+1)+'\n');
            ind=0;
           // System.out.println("*********Cipher Block In Round ********* "+ Round+'\n');
            for(int d=0 ; d<8; d++){
                for(int j=0; j<8; j++){
          ...
          //  arrayprinter.printarray(newBlock64_S,"Cipher Block");
            ...
            while(Round<=16) {
              ...
              // System.out.println("*********Right Part XORED with Round Key********* "+Round+'\n');
              ...
              //  arrayprinter.printarray(XORS,"XOR Result");
               ...
               // System.out.println("*********Left Part XORED with Output Function in Round********* "+Round+'\n');
        ...
        for(int f=0; f<PlainText.length()/8; f++){
          ...
          //  System.out.println("*********Block Number *********"+(f+1)+'\n');
           ...
           // System.out.println("*********Key Generation*********" +'\n');
            ...
            while(Round<=16) {
              ...
              //  System.out.println("Chooser = "+chooser);
               ...
               // System.out.println("*********Key For Round Number********* "+Round+'\n');
           ...
           // }
            ...
            p.FillInversePermutation();//step1 from 2D to 1D
           // System.out.println("********* Inverse Permutation Operation in Round *********"+(f+1)+'\n');
            p.DoInverseIP(Block64,newBlock64);//step1 -array
           // System.out.println(" ");
